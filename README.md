...
相比 v1 版本，v2 不再只是“能跑通 RAG 流程”的 demo，而是重点解决真实问答中常见的检索不准、关键词丢失、答案无来源、结果不可追溯等问题，更适合作为面试项目展示。
...
<p align="center">
  <img src="./docs/images/rag-v2-architecture.png" alt="DocuRAG RAG v2 系统架构图" width="900">
</p>
